...
There are 5 presets available (submit a PR to add more if you want). Each preset is basically a collection
...
Same as gopro7 but takes into account (optional) stream name changes. 
